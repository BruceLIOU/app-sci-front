...
const Quittances = React.lazy(
	() => import("./views/admin/quittances/Quittances"),
);
const Charges = React.lazy(() => import("./views/admin/charges/Charges"));
const Comptability = React.lazy(
	() => import("./views/admin/comptability/Comptability"),
);
const Associates = React.lazy(
	() => import("./views/admin/associates/Associates"),
);
const Declarations = React.lazy(
	() => import("./views/admin/declarations/Declarations"),
);
