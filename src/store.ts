...
export interface UserPreferences {
	darkMode: boolean;
	// biome-ignore lint/suspicious/noExplicitAny: préférences utilisateur dynamiques
	[key: string]: any;
}
...
const ownerSlice = createSlice({
	...
	reducers: {
		setOwnerProfileType: (
			state,
			action: PayloadAction<"SCI" | "PROFESSIONAL" | "INDIVIDUAL">,
		) => {
...
export const { setUser, setLoading, updatePreferences, updateProfile } =
	authSlice.actions;
