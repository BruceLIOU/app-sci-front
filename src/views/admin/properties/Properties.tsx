...
const Properties = () => {
  ...
  const handleViewProperty = (id: number) => { setPropertyId(id); setModalType('view'); setModalVisible(true) }
              ...
              <CCard>
                <CCardBody>
                  ...
                  <div className="d-grid gap-2 d-md-flex justify-content-md-end">
                    <CTooltip content="Voir"><CButton color="light" onClick={() => handleViewProperty(item.id)}><CIcon icon={cilContact} /></CButton></CTooltip>
                    <CTooltip content="Modifier"><CButton color="light" onClick={() => handleEditProperty(item.id)}><CIcon icon={cilPen} /></CButton></CTooltip>
                    <CTooltip content="Supprimer"><CButton color="light" onClick={() => handleDeleteProperty(item.id)}><CIcon icon={cilTrash} /></CButton></CTooltip>
                  </div>
                </CCardBody>
