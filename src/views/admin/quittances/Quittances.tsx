...
const Quittances = () => {
	...
	const {
		...
		toForm: (q) => ({
			tenant_id: q.tenant_id ? String(q.tenant_id) : "",
			property_id: q.property_id ? String(q.property_id) : "",
			lease_id: q.lease_id ? String(q.lease_id) : "",
			payment_id: q.payment_id ? String(q.payment_id) : "",
			period: q.period || "",
