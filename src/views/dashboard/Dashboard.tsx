  ...
  const tableExample = [
    {
      ...
      user: { name: 'Yiorgos Avraamu', new: true, registered: 'Jan 1, 2021' },
    ...
    },
    {
      ...
      user: { name: 'Avram Tarasios', new: false, registered: 'Jan 1, 2021' },
    ...
    },
    {
      ...
      user: { name: 'Agapetus Tadeáš', new: true, registered: 'Jan 1, 2021' },
    ...
    },
    {
      ...
      user: { name: 'Friderik Dávid', new: true, registered: 'Jan 1, 2021' },
          ...
          <CChartLine
            ...
            options={{
              ...
              scales: {
                ...
                y: { min: 0, max: 250, ticks: { maxTicksLimit: 5, stepSize: Math.ceil(250 / 5) } },
              },
              elements: {
                line: { tension: 0.4 },
                    ...
                    <CTableRow key={index}>
                      ...
                      <CTableDataCell>
                        <div className="clearfix">
                          <div className="float-start"><strong>{item.usage.value}%</strong></div>
                          <div className="float-end"><small className="text-medium-emphasis">{item.usage.period}</small></div>
                        </div>
