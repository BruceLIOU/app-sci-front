...
>(({ className, children, ...props }, ref) => (
	<DialogPortal>
		...
		>
			...
			<DialogPrimitive.Close className="absolute right-4 top-4 flex size-7 items-center justify-center rounded-full bg-muted/50 text-muted-foreground transition-colors hover:bg-muted hover:text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none">
				<X className="h-4 w-4" />
...
const DialogHeader = ({
	...
	<div
		className={cn(
			"flex flex-col space-y-1 pb-4 mb-2 border-b border-border/60",
			className,
		)}
		{...props}
	/>
