...
export const testScenarios = {
  ...
  individual: {
    ...
    hiddenFields: ['legal_form', 'siret', 'rcs', 'manager_civility', 'manager_firstname', 'manager_lastname', 'manager_email', 'manager_phone'],
  ...
  professional: {
    type: 'PROFESSIONAL',
    expectedFields: ['legal_form', 'name', 'siret', 'rcs', 'address', 'zipcode', 'city', 'iban', 'manager_civility', 'manager_firstname', 'manager_lastname', 'manager_email', 'manager_phone'],
    hiddenFields: [],
  ...
  sci: {
    type: 'SCI',
    expectedFields: ['legal_form', 'name', 'siret', 'rcs', 'address', 'zipcode', 'city', 'iban', 'manager_civility', 'manager_firstname', 'manager_lastname', 'manager_email', 'manager_phone', 'manager_associate_id'],
    hiddenFields: [],
